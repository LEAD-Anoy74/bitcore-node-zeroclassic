...
Bitcoin.DEFAULT_CONFIG_SETTINGS = [
  "rpcuser=ZeroClassicNodeUsername",
  "rpcpassword=ZeroClassicNodePassword",
  "rpcport=23800",
  ...
  "addnode=zeroclassicseed.cryptoforge.cc:23801",
  "addnode=84.19.36.203:23801",
  "addnode=zeroclassiccurrency.prophetalgorithms.com:23801",
  "txindex=1",
  "addressindex=1",
  "timestampindex=1",
  "spentindex=1",
...
Bitcoin.prototype._loadSpawnConfiguration = function(node) {
  ...
  var configPath = path.resolve(spawnOptions.datadir, './zeroinsight.conf');
...
Bitcoin.prototype._checkConfigIndexes = function(spawnConfig, node) {
  ...
  $.checkState(
    ...
    '"zmqpubrawtx" and "zmqpubhashblock" are expected to the same host and port in zeroinsight.conf'
  );
...
Bitcoin.prototype._getNetworkConfigPath = function() {
  var networkPath;
  if (this.node.network === bitcore.Networks.testnet) {
    networkPath = 'testnet3/zeroinsight.conf';
    if (this.node.network.regtestEnabled) {
      networkPath = 'regtest/zeroinsight.conf';
    }
  }
  return networkPath;
};
